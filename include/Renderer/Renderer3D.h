...
namespace UE {
    ...
    public:
        ...
        static void DrawModel(const Ref<Model>& model,const glm::mat4& transform, const glm::vec3& color = glm::vec3(1));
        ...
        static void DrawCube(const glm::mat4& transform, const glm::vec3& color = glm::vec3(1));
